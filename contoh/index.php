        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form ACTION="<?php echo $loginFormAction; ?>" method="POST" target="_self" id="loginuser">
              ...
              <div>
                <input class="btn btn-primary submit" type="submit" value="Masuk >>">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Buku Induk Siswa</h1>
                  <h2>SMP Tahfidzqu</h2>
                  <p>©2016 All Rights Reserved. <br/>Developed by Fadhel Muhammad Gintings on Godspeed Digital</p>
                </div>
              </div>
            </form>
          </section>
