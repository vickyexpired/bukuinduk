...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tedu (level_edu) VALUES (%s)",
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Level Pendidikan <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="level_edu" name="level_edu" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                  ...
                  <div class="x_title">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						<?php do { ?>
						  <tr>
							<td><?php echo $row_tampil['id_edu']; ?></td>
							<td><?php echo $row_tampil['level_edu']; ?></td>
							<td>
							<div class='btn-group'>
								  <a href="hapusedu.php?id_edu=<?php echo $row_tampil['id_edu']; ?>" class="btn btn-danger btn-xs glyphicon glyphicon-remove tipsy-kiri-atas" title="Hapus Data Ini"><i class="icon-remove icon-white"></i></a> 
								  <a href="formeditedu.php?id_edu=<?php echo $row_tampil['id_edu']; ?>" class="btn btn-default btn-xs glyphicon glyphicon-pencil tipsy-kiri-atas" title='Edit Data ini'> <i class="icon-edit icon-white"></i> </a></div>
							</td>
						  </tr>
