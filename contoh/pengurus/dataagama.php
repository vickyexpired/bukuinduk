                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" novalidate action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Agama<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama_agama" name="nama_agama" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <tbody>
						<?php do { ?>
						  <tr>
							...
							<td>
							<div class='btn-group'>
								  <a href="hapusagama.php?id_agama=<?php echo $row_tampil['id_agama']; ?>" class="btn btn-danger btn-xs glyphicon glyphicon-remove tipsy-kiri-atas" title="Hapus Data Ini"><i class="icon-remove icon-white"></i></a> 
								  <a href="formeditagama.php?id_agama=<?php echo $row_tampil['id_agama']; ?>" class="btn btn-default btn-xs glyphicon glyphicon-pencil tipsy-kiri-atas" title='Edit Data ini'> <i class="icon-edit icon-white"></i> </a></div>
							</td>
						  </tr>
