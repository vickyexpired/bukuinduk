	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <?= form_open_multipart('admin/data_siswa/add/',array('class' => 'form-horizontal form-label-left')) ?>
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input required type="text" class="form-control" id="penyakit_kronis_lama" placeholder="Lama penyakit Kronis" name="penyakit_kronis_lama">
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" align="center">
                <input type="submit" name="submit" value="Tambah" onclick="return confirm('Apakah anda yakin?')" class="btn btn-primary btn-lg">
