...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="row">
            	<?= anchor('admin/data_siswa/','<span class="fa fa-arrow-left"></span> Back',array('class' => 'btn btn-primary btn-lg')); ?>
            	<?= anchor('admin/data_siswa/print_siswa/'.$record_siswa['id_siswa'],'<span class="fa fa-print"></span> Print',array('class' => 'btn btn-warning btn-lg','target' => '_blank')) ?>
            </div>
            <div class="row">
